...
const GoogleSignInButton = ({ isLoading, setIsLoading }) => {
  ...
  return (
    <button
      ...
      disabled={isLoading}
      className="w-full py-3 bg-white hover:bg-gray-50 text-gray-700 font-semibold rounded-lg transition-all duration-300 transform hover:scale-[1.02] border-2 border-gray-200 hover:border-gray-300 hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-3 text-sm relative overflow-hidden group"
    >
